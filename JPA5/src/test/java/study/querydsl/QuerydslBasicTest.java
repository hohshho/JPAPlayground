...
public class QuerydslBasicTest {
    ...
    @Test
    public void startQuerydsl3() { //member1을 찾아라.
        Member findMember = queryFactory
                .select(member)
                .from(member)
    ...
    public void resultFetch() {
        ...
        //단 건 -> 결과가 둘 이상이면 com.querydsl.core.NonUniqueResultException
...
//                        member.age.eq(100)
    ...
    @Test
    public void dtoJPA() throws Exception {
...
//     3. 생성자 사용
    @Test
    public void dtoQueryDSLProperties() throws Exception {
    ...
    @Test
    public void dtoQueryDSLField() throws Exception {
        List<MemberDto> result = queryFactory
    ...
    // 별칭 다를 때
    @Test
    public void dtoQueryDSLFieldAnotherAlias() throws Exception {
        QMember memberSub = new QMember("memberSub");
    ...
    @Test
    public void dtoQueryDSLFieldQueryProjection() throws Exception {
        List<UserDto> result = queryFactory
